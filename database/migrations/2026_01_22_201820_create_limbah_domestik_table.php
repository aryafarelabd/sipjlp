...
return new class extends Migration {
    ...
    {
        Schema::create('limbah_domestik', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('tipe_limbah', ['domestik', 'medis'])->default('domestik');
            $table->enum('jenis_limbah', ['organik', 'anorganik', 'kompos'])->nullable();
