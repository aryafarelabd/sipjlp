...
@section('title', 'Logbook Dekontaminasi Udara')
    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Logbook Dekontaminasi Udara</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-xl">
        ...
        <div class="alert alert-info mb-3">
            <div class="d-flex">
                ...
                <div>
                    <strong>Jadwal Dekontaminasi Udara:</strong>
                    <ul class="mb-0 mt-1 small">
                        <li>Poli TB & Poli Paru — setiap Sabtu (1x seminggu)</li>
                        <li>Ruang Isolasi IGD — setiap setelah pasien isolasi selesai</li>
                        <li>Ruang Isolasi Rawat Inap — setiap setelah pasien isolasi pulang</li>
                        <li>HCU/ICU, VK, OK, Rawat Inap, Perina, Poli Rajal, IGD, KMJ — apabila ada pasien penyakit menular</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row g-3">
            ...
            {{-- ── Kolom Kiri: Form ──────────────────────────────────── --}}
            <div class="col-lg-6">
                <form method="POST" action="{{ route('logbook-dekontaminasi.store') }}" enctype="multipart/form-data">
                @csrf

                <div class="card mb-3">
                    <div class="card-header" style="background-color:#fd7e14;">
                        <h3 class="card-title text-white">
                            <i class="ti ti-wind me-2"></i>Pencatatan Dekontaminasi Udara
                        </h3>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label required">Tanggal Dekontaminasi</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label required">Shift Jaga</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label required">Lokasi / Ruangan yang Didekontaminasi</label>
                            <textarea name="lokasi" rows="3"
                                      class="form-control @error('lokasi') is-invalid @enderror"
                                      placeholder="Contoh: Ruang Isolasi IGD, Poli Paru Lt.1"
                                      required>{{ old('lokasi') }}</textarea>
                            <div class="form-hint">Tulis semua ruangan yang sudah didekontaminasi udara.</div>
                        ...
                        <div class="mb-3">
                            <label class="form-label required">
                                Bukti Kegiatan
                                <span class="text-muted small fw-normal">(maks. 5 foto, wajib ber-timestamp)</span>
                            </label>
                            ...
                            <div class="form-hint">Foto dokumentasi harus menampilkan timestamp waktu.</div>
                ...
                <button type="submit" class="btn btn-primary w-100 mb-4">
                    <i class="ti ti-device-floppy me-1"></i>Simpan Logbook Dekontaminasi
                </button>
                </form>
            </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="ti ti-history me-1"></i>Riwayat Dekontaminasi Udara
                        </h3>
                        <div class="card-actions">
                            <form method="GET" action="{{ route('logbook-dekontaminasi.index') }}"
                    ...
                    <div class="card-body border-bottom py-2">
                        <div class="row g-2 text-center">
                            <div class="col">
                                <div class="text-muted" style="font-size:11px;">Total Entri</div>
                                <div class="fw-bold">{{ $riwayat->count() }}</div>
                            </div>
                            <div class="col">
                                <div class="text-muted" style="font-size:11px;">Bulan Ini</div>
                                <div class="fw-bold text-blue">{{ \Carbon\Carbon::create(null, $bulan)->translatedFormat('F') }} {{ $tahun }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group list-group-flush overflow-auto" style="max-height:70vh;">
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="text-muted small mb-2">
                                <i class="ti ti-map-pin me-1"></i>{{ $log->lokasi }}
                            </div>
                            @if($log->catatan)
                            <div class="text-muted small mb-2">
                                <i class="ti ti-note me-1"></i>{{ $log->catatan }}
                            </div>
                            @endif
