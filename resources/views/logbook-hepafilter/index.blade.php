...
@section('title', 'Logbook Cleaning Hepafilter')
    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Logbook Cleaning Hepafilter</h2>
            </div>
        </div>
    </div>
</div>
...
<div class="page-body">
    <div class="container-xl">
        ...
        <div class="row g-3">
            ...
            {{-- ── Kolom Kiri: Form ──────────────────────────────────── --}}
            <div class="col-lg-6">
                <form method="POST" action="{{ route('logbook-hepafilter.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="mb-0">
                            <label class="form-label required">Tanggal Cleaning</label>
                ...
                <div class="card mb-3">
                    <div class="card-header" style="background-color:#fd7e14;">
                        <h3 class="card-title text-white">
                            <i class="ti ti-filter me-2"></i>Hepafilter yang Dibersihkan
                            <small class="fw-normal ms-1 opacity-75">— Centang ruangan yang sudah dibersihkan</small>
                        </h3>
                    </div>
                    <div class="card-body">
                        @error('ruangan')
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label">
                                Foto Dokumentasi
                                <span class="text-muted small fw-normal">(maks. 10 foto)</span>
                            </label>
                            <input type="file" name="foto[]" accept="image/*" multiple
                                   ...
                                   id="inputFoto">
                            <div class="form-hint">Foto filter yang sudah dibersihkan.</div>
                ...
                <button type="submit" class="btn btn-primary w-100 mb-4">
                    <i class="ti ti-device-floppy me-1"></i>Simpan Logbook Hepafilter
                </button>
                </form>
            </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="ti ti-history me-1"></i>Riwayat Cleaning Hepafilter
                        </h3>
                        <div class="card-actions">
                            <form method="GET" action="{{ route('logbook-hepafilter.index') }}"
                    ...
                    <div class="card-body border-bottom py-2">
                        <div class="row g-2 text-center">
                            ...
                            <div class="col">
                                <div class="text-muted" style="font-size:11px;">Total Cleaning</div>
                                <div class="fw-bold text-orange">{{ $riwayat->sum('total_ruangan') }} ruangan</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group list-group-flush overflow-auto" style="max-height:70vh;">
                        ...
                        <div class="list-group-item">
                            ...
                            @if($log->catatan)
                            <div class="text-muted small"><i class="ti ti-note me-1"></i>{{ $log->catatan }}</div>
                            @endif
