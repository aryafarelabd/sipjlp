...
@section('title', 'Rekap Laporan Security Patrol')
    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Rekap Laporan Security Patrol</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-xl">
        ...
        <div class="card mb-3">
            <div class="card-body py-2">
                <form method="GET" action="{{ route('patrol-inspeksi.rekap') }}" class="row g-2 align-items-end">
                    <div class="col-sm-2">
            ...
            <div class="card-footer d-flex justify-content-end py-2 border-top">
                @include('exports.partials.buttons', ['route' => 'export.patrol-inspeksi', 'params' => ['bulan' => $bulan, 'tahun' => $tahun, 'area' => $area, 'search' => $search]])
            </div>
            </div>
        </div>
            ...
            <div class="col-sm-4">
                <div class="card card-sm">
                    <div class="card-body text-center">
                        ...
                        @php
                            $rataRata = $logbooks->count() > 0
                                ? round($logbooks->avg('persentase'))
                                : 0;
                        @endphp
                        <div class="h2 mb-0 {{ $rataRata >= 80 ? 'text-success' : ($rataRata >= 60 ? 'text-warning' : 'text-danger') }}">
                            {{ $rataRata }}%
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><i class="ti ti-table me-1"></i>Data Laporan Security Patrol</h3>
            ...
            <div class="card-body">
                <div class="empty py-4">
                    ...
                    <p class="empty-subtitle text-muted">Belum ada laporan security patrol untuk periode ini.</p>
                </div>
            </div>
            @else
                ...
                <table class="table table-vcenter card-table table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="small">{{ \App\Models\PatrolInspeksi::AREA[$log->area] ?? $log->area }}</span>
                            </td>
                            <td class="text-center">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="small fw-medium {{ $pct >= 80 ? 'text-success' : ($pct >= 60 ? 'text-warning' : 'text-danger') }}">
                                        {{ $pct }}%
                                    </span>
                                </div>
                            </td>
